...
def get_land_D_mtx(land_ids_temp):
	...
	for i,l in enumerate(land_ids_temp):
		...
		save('/scratch/kchowdh/L2n_i' + str(i).zfill(3), temp)
...
nL = 200
np = 28 # number of procs for landmark
np2 = 14 # number of procs for nonlandmark test pairs
...
# get test pairs
R, R0, splitR0 = get_test_split(nonland_ids, node_list,100000)
